...
function btnDeleteClicked(id) {
    const Obj = {};
    Obj.marca_idRemove = id;
    Obj.filterMarcaName = $('#filterMarcaName').val();
    if (!containsSpecialCharsNombre($('#filterMarcaName').val())) {
        $.ajax({
